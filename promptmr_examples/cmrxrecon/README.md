...
All the following commands for reproducing the results on CMRxRecon dataset are run under the `promptmr_examples/cmrxrecon` folder.
...
You can also use the following command to download the models to the `pretrained_models` folder:
